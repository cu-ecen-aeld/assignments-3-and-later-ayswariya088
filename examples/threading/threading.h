...
struct thread_data
{
    ...
    int wait_to_obtain_ms;  // sleeps @param wait_to_obtain_ms number of milliseconds
    int wait_to_release_ms; // holds for @param wait_to_release_ms milliseconds, then releases.
